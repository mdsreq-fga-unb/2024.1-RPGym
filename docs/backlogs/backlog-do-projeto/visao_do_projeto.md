...
| ------------------------------------------------------------------------------------ | ---------------------------- | ----------------------- | ------------------------------------------------------------- |
| Atividades de planejamento (Sprint Planning)                                         | Equipe do Projeto            | A cada uma semana       | Documentação da Sprint Planning                             |
| Acompanhamento das atividades, riscos, compromissos, ações pendentes e indicadores | Equipe do Projeto            | No horário de aula     | Tasks no kanban, relatório diário                           |
| Verificação e Validação do produto (Review)                                      | Equipe, Cliente              | A cada uma semana       | Documentação da Sprint Review                               |
