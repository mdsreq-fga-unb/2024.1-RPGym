...
| F10 | US19 | Eu, como usuário, conversar com outros usuarios via chat nos grupos que faço parte. | - O sistema deve permitir que o usuário do grupo veja as mensagens de outros usuários.<br>- O usuário deve poder enviar mensagens nesse chat.<br>- O sistema deve armazenar as mensagens por tempo indeterminado. |
